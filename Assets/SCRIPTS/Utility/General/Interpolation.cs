...
public static class Interpolation {
	...
	/// <summary>
	/// Interpolate between 2 vector2s with a specified interpolation method.
	/// </summary>
	public static Vector2 Interpolate (Vector2 a, Vector2 b, float t, InterpolationMethod method) {
		return Vector2.Lerp (a, b, TimeScale (t, method));
	}

	/// <summary>
	/// Interpolate between 2 vector3s with a specified interpolation method.
	/// </summary>
